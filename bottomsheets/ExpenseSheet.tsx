...
const AddExpenseBottomSheet = forwardRef<RefProp, Props>(({ onClose }, ref) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <View style={[styles.pickerContainer1, { borderColor: theme.border }]}>
          <Picker
        ...
        {/* Payment Method */}
        <ThemedText style={styles.label}>Payment Method (optional)</ThemedText>
        <BottomSheetTextInput
          style={[
            styles.input,
            { borderColor: theme.border, color: theme.text },
